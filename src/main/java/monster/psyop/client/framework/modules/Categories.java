...
public class Categories {
    public static final Category[] INDEX = new Category[9];
    ...
    public static final Category
            ...
            HUD = INDEX[5] = new Category("HUD", "Displays HUD elements."),
            CHAT = INDEX[6] = new Category("Chat", "Modules that add to/tweak chat."),
            EXPLOITS = INDEX[7] = new Category("Exploits", "Exploits and Co"),
            SILLY = INDEX[8] = new Category("Silly", "You probably shouldn't enable this.");
}
